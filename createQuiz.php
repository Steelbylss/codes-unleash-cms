...
<body>
    ...
    <div class="content-container">
                ...
                <div class="content section active" id="quizzesSection">
                    <h2>Quiz</h2>
                    <form id="quizForm">
                        <label for="createquizRefNum" class="form-label">Chapter Reference Number:</label>
                        <input type="text" id="createquizRefNum" name="chapter_reference_number" class="form-input" required>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            quizForm.addEventListener('submit', function(event) {
                ...
                fetch('http://192.168.1.7/api/chapter_assessment/create', {
                    method: 'POST',
                    body: formData,
                    headers: {

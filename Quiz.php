...
<body>
    ...
    <div class="content-container">
        ...
        <button class="create-new-button" onclick="window.location.href = 'createQuiz.php'">Create</button>
        <button class="create-new-button" onclick="window.location.href = 'updateQuiz.php'">Update</button>
        </div>
      ...
      document.addEventListener('DOMContentLoaded', function() {
            ...
            .then(data => {
                ...
                data.results.forEach(chapter => {
                    chapter.chapter_assessment.forEach(assessment => {
                        const row = document.createElement('tr');
                        row.innerHTML = `
                            <td>${chapter.chapter}</td>
                            <td>${assessment.question_number}</td>
                            <td>${assessment.question}</td>
                            <td>[1] ${assessment.choice_1}<br/>[2] ${assessment.choice_2}<br/>[3] ${assessment.choice_3}<br/>[4] ${assessment.choice_4}</td>

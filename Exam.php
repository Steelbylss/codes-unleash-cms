...
<body>
    ...
    <div class="content-container">
        ...
        <button class="create-new-button" onclick="window.location.href = 'createExam.php'">Create</button>
        <button class="create-new-button" onclick="window.location.href = 'updateExam.php'">Update</button>
        </div>
      ...
      document.addEventListener('DOMContentLoaded', function() {
            ...
            .then(data => {
                ...
                data.results.forEach(exam => {
                    ...
                    row.innerHTML = `
                    <td>${exam.programming_language}</td>
                    <td>${exam.question_number}</td>
                    <td>${exam.question}</td>
                    <td>${exam.code_snippet}</td>
                    <td>[1] ${exam.choice_1}<br/>[2] ${exam.choice_2}<br/>[3] ${exam.choice_3}<br/>[4] ${exam.choice_4}</td>

...
<body>
    ...
    <div class="content-container">
        ...
        <button class="create-new-button" onclick="window.location.href = 'createChapter.php'">Create</button>
        <button class="create-new-button" onclick="window.location.href = 'updateChapter.php'">Update</button>
        </div>
            ...
            .then(data => {
                ...
                data.results.forEach(result => {
                  result.chapters.forEach(chapter => {
                    ...
                    row.innerHTML = `
                        <td>${result.programming_language}</td>
                        <td>${chapter.chapter_name}</td>
                        <td>${chapter.reference_number}</td>
                        <!-- Add more columns if needed -->
                    `;
